...
export default function Home() {
  return (
    <main className="flex flex-col min-h-[calc(100vh-56px)] items-center justify-start">
      ...
      <section className="grid grid-cols-[1fr,1fr] md:grid-cols-[1fr_200px] gap-1 md:gap-5 h-full sm:w-4/5 mx-auto mt-16">
        <section className="grid  md:grid-cols-4 gap-1 md:gap-5">
          <div className="bg-secondary dark:bg-secondary-dark rounded-5xl lg:rounded-6xl flex items-center min-h-[100px] max-md:col-span-2 md:col-span-2 lg:col-span-3">
