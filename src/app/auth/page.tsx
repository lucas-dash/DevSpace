...
export default async function Auth() {
  ...
  return (
    <section className="flex flex-col items-center relative min-h-screen">
      ...
      <div className="rounded-full bg-foreground dark:bg-foreground-dark absolute h-[180px] w-[180px] left-[5%] top-[53%] -z-10"></div>

      <div className="rounded-full bg-accent dark:bg-accent-dark absolute h-[160px] w-[160px] right-[8%] bottom-[11%] -z-10"></div>

      <div className="rounded-full bg-foreground dark:bg-foreground-dark absolute h-[100px] w-[100px] right-[6%] top-[32%] -z-10"></div>
